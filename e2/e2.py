...
indici_stazione1 = rd.selezione_indirizzo(california,'1630 N MAIN ST, LOS ANGELES') #site num=1103 univoco ma non usato per uniformità
...
indici_stazione2 = rd.selezione_indirizzo(california,'170 meters SE of Donna Dr. & Humboldt Hill Rd., Eureka, CA') #site num=1005 univoco ma non usato per uniformità
...
indici_stazione3 = rd.selezione_indirizzo(california,'1029 ETHEL ST, CALEXICO HIGH SCHOOL') #site num causa ambiguità. 'Site Num'=5 non univoco con indirizzo e/o contea e/o città
...
indici_stazione4 = rd.selezione_indirizzo(california,'1865 D RUMRILL BLVD, San Pablo') #site num causa ambiguità. 'Site Num'=1004 non univoco con indirizzo e/o contea e/o città
...
for i in tqdm(range(len(date))):
    ...
    medie_california.iloc[i,1:] = rd.media_stato(california,indici_data)
...
for i in tqdm(range(len(date))):
    ...
    medie_colorado.iloc[i,1:] = rd.media_stato(colorado,indici_data)
...
for i in tqdm(range(len(date))):
    ...
    medie_new_york.iloc[i,1:] = rd.media_stato(new_york,indici_data)
...
for i in tqdm(range(len(date))):
    ...
    medie_south_dakota.iloc[i,1:] = rd.media_stato(south_dakota,indici_data)
...
for i in tqdm(range(len(date))):
    ...
    medie_texas.iloc[i,1:] = rd.media_stato(texas,indici_data)
...
stazione1_riempita = rd.riempi(stazione1)
stazione2_riempita = rd.riempi(stazione2)
stazione3_riempita = rd.riempi(stazione3)
stazione4_riempita = rd.riempi(stazione4)
medie_california_riempita = rd.riempi(medie_california)
medie_colorado_riempita = rd.riempi(medie_colorado)
medie_new_york_riempita = rd.riempi(medie_new_york)
medie_south_dakota_riempita = rd.riempi(medie_south_dakota)
medie_texas_riempita = rd.riempi(medie_texas)
medie_nazione_riempita = rd.riempi(medie_nazione)
